const NetflixForm = Vue.component('netflix-form', {
    template: `
<form id="netflix-form" @submit.prevent="process()" >    
    ...
    methods: {
        process: function() {
            console.log("form: show_id=", this.show_id, "type=", this.type, "title=", this.title, 'director=', this.director, 'cast=', this.cast, 'country=', this.country, 'date_added=', this.date_added, 'director=', this.release_year, 'rating=', this.rating, 'duration=', this.duration, 'listed_in=', this.listed_in, 'description=', this.description);
            record = {
